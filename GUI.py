...
button_settings2 = tkinter.Button(root, image=img_button_settings2, height=70, width=240, bg='#2b3136', activebackground='#2b3136', bd=0)
button_settings2.pack()
button_settings2.place(relx=0.050, rely=0.76)

img_button_commands2 = tkinter.PhotoImage(file='GUI/commands_button2.png')
commands_settings2 = tkinter.Button(root, image=img_button_commands2, height=70, width=240, bg='#2b3136', activebackground='#2b3136',
                                    bd=0, command=command_window)
commands_settings2.pack()
commands_settings2.place(relx=0.48, rely=0.76)
